const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/toast-notification-BppDpdnp.js","assets/lit-D6WVJR7_.js"])))=>i.map(i=>d[i]);
import{I as t,B as e,g as o,S as i,d as s,s as a,a as n}from"./toast-notification-BppDpdnp.js";import{i as r,n as l,a as d,b as c,t as p,e as h,r as b}from"./lit-D6WVJR7_.js";var u=Object.defineProperty,f=Object.getOwnPropertyDescriptor,m=(t,e,o,i)=>{for(var s,a=i>1?void 0:i?f(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(a=(i?s(e,o,a):s(a))||a);return i&&a&&u(e,o,a),a};let g=class extends d{constructor(){super(...arguments),this._i18n=new t(this),this.active="data"}_select(t){this.active=t,this.dispatchEvent(new CustomEvent("tab-change",{detail:t,bubbles:!0,composed:!0}))}render(){return c`
      <div class="brand">
  ...
  `,V([l({type:Boolean,reflect:!0})],Q.prototype,"open",2),V([l({type:String})],Q.prototype,"title",2),V([l({type:String})],Q.prototype,"size",2),Q=V([p("modal-dialog")],Q);var H=Object.defineProperty,J=Object.getOwnPropertyDescriptor,Y=(t,e,o,i)=>{for(var s,a=i>1?void 0:i?J(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(a=(i?s(e,o,a):s(a))||a);return i&&a&&H(e,o,a),a};let G=null,W=class extends d{constructor(){super(...arguments),this._i18n=new t(this),this.mode="add",this.data={},this._formData={name:"",description:"",url:"",fields:[],buttonName:"",buttonSelector:""}}open(t){t?(this.data={...t},this._formData={name:t.name,description:t.description,url:t.url,fields:t.fields.map(t=>({id:t.id,name:t.name,selector:t.selector,value:""})),buttonName:t.button?.name??"",buttonSelector:t.button?.selector??""}):this._formData=G?{...G,fields:[...G.fields]}:{name:"",description:"",url:"",fields:[],buttonName:"",buttonSelector:""},this.requestUpdate();const e=this.renderRoot.querySelector("#modal");e&&(e.open=!0)}close(){"add"===this.mode&&this._saveDraft();const t=this.renderRoot.querySelector("#modal");t&&(t.open=!1),this.dispatchEvent(new CustomEvent("modal-close",{bubbles:!0,composed:!0}))}_onFormChange(t){this._formData=t.detail,this.requestUpdate()}_submit(){const t=this._formData;if(!t.name.trim())return;const e=t.fields.filter(t=>t.name.trim()).map(t=>({id:t.id,name:t.name.trim(),selector:t.selector?.trim()??""})),o=t.buttonSelector.trim()?{name:t.buttonName.trim()||"Submit",selector:t.buttonSelector.trim()}:void 0;this.dispatchEvent(new CustomEvent("template-submit",{detail:{name:t.name.trim(),description:t.description.trim(),url:t.url.trim(),fields:e,button:o},bubbles:!0,composed:!0})),this._clearDraft(),this.close()}_saveDraft(){G={...this._formData,fields:[...this._formData.fields]}}_clearDraft(){G=null}render(){const t="edit"===this.mode?this._i18n.t("template.edit"):"copy"===this.mode?this._i18n.t("template.copy"):"extract"===this.mode?this._i18n.t("template.extract"):this._i18n.t("template.new");return c`
  ...
  `,ht=((t,e,o,i)=>{for(var s,a=i>1?void 0:i?pt(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(a=s(a)||a);return a})([p("cookie-settings")],ht);var bt=Object.getOwnPropertyDescriptor;let ut=class extends d{constructor(){super(...arguments),this._i18n=new t(this)}render(){return c`
      <div class="guide">
  ...
  `,ut=((t,e,o,i)=>{for(var s,a=i>1?void 0:i?bt(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(a=s(a)||a);return a})([p("guide-page")],ut);var ft=Object.defineProperty,mt=Object.getOwnPropertyDescriptor,gt=(t,e,o,i)=>{for(var s,a=i>1?void 0:i?mt(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(a=(i?s(e,o,a):s(a))||a);return i&&a&&ft(e,o,a),a};let xt=class extends d{constructor(){super(...arguments),this._i18n=new t(this),this._tab="data"}_onTabChange(t){this._tab=t.detail}_toggleLang(){a.setLanguage("en"===n()?"zh":"en")}render(){return c`
      <div class="main">
  ...
  `,gt([b()],xt.prototype,"_tab",2),xt=gt([p("config-app")],xt);
