const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/toast-notification-CTcGFgSq.js","assets/lit-D6WVJR7_.js"])))=>i.map(i=>d[i]);
import{I as t,B as e,g as o,S as i,d as s,s as r,a as n}from"./toast-notification-CTcGFgSq.js";import{i as a,n as l,a as d,b as c,t as p,r as h,e as u}from"./lit-D6WVJR7_.js";var g=Object.defineProperty,b=Object.getOwnPropertyDescriptor,m=(t,e,o,i)=>{for(var s,r=i>1?void 0:i?b(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=(i?s(e,o,r):s(r))||r);return i&&r&&g(e,o,r),r};let f=class extends d{constructor(){super(...arguments),this._i18n=new t(this),this.active="data"}_select(t){this.active=t,this.dispatchEvent(new CustomEvent("tab-change",{detail:t,bubbles:!0,composed:!0}))}render(){return c`
      <div class="brand">
  ...
  `,I([l({type:Number})],z.prototype,"selectedCount",2),I([l({type:Boolean})],z.prototype,"showImport",2),I([l({type:Boolean})],z.prototype,"showExport",2),I([l({type:Boolean})],z.prototype,"showDelete",2),z=I([p("batch-toolbar")],z);var O=Object.defineProperty,A=Object.getOwnPropertyDescriptor,L=(t,e,o,i)=>{for(var s,r=i>1?void 0:i?A(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=(i?s(e,o,r):s(r))||r);return i&&r&&O(e,o,r),r};let P=class extends d{constructor(){super(...arguments),this.open=!1,this.title="Confirm",this.message="Are you sure?",this.confirmLabel="Delete",this.cancelLabel="Cancel"}confirm(){this.open=!1,this.dispatchEvent(new CustomEvent("confirm",{bubbles:!0,composed:!0}))}cancel(){this.open=!1,this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){return this.open?c`
    ...
    `:c``}};function M(t,e){if(!t||"object"!=typeof t||Array.isArray(t))throw new Error(`${e} must be a JSON object.`);return t}function F(t){if(!t.trim())throw new Error("Paste JSON before saving.");const e=JSON.parse(t);if(!Array.isArray(e))return M(e,"JSON");if(1!==e.length)throw new Error("Import exactly one item in this dialog.");return M(e[0],"Array item")}function R(t,e){if("string"!=typeof t||!t.trim())throw new Error(`${e} is required.`);return t.trim()}function N(t){return"string"==typeof t?t.trim():""}P.styles=a`
    :host { display: none; }
  ...
  `,L([l({type:Boolean,reflect:!0})],P.prototype,"open",2),L([l({type:String})],P.prototype,"title",2),L([l({type:String})],P.prototype,"message",2),L([l({type:String})],P.prototype,"confirmLabel",2),L([l({type:String})],P.prototype,"cancelLabel",2),P=L([p("confirm-dialog")],P);var U=Object.defineProperty,B=Object.getOwnPropertyDescriptor,q=(t,e,o,i)=>{for(var s,r=i>1?void 0:i?B(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=(i?s(e,o,r):s(r))||r);return i&&r&&U(e,o,r),r};let J=class extends d{constructor(){super(...arguments),this.fields=[],this.mode="definition",this.readonly=!1,this.showDrag=!1}_notify(){this.dispatchEvent(new CustomEvent("fields-change",{detail:[...this.fields],bubbles:!0,composed:!0}))}_updateField(t,e,o){this.fields=this.fields.map(i=>i.id===t?{...i,[e]:o}:i),this._notify()}addRow(){this.fields=[...this.fields,{id:o(),name:"",selector:"",value:""}],this._notify()}copyRow(t){const e=this.fields.findIndex(e=>e.id===t);if(-1===e)return;const i=this.fields[e],s={...i,id:o(),name:i.name+" (copy)"},r=[...this.fields];r.splice(e+1,0,s),this.fields=r,this._notify()}deleteRow(t){this.fields=this.fields.filter(e=>e.id!==t),this._notify()}_onDragStart(t,e){t.dataTransfer.effectAllowed="move",t.dataTransfer.setData("text/plain",String(e))}_onDragOver(t){t.preventDefault(),t.dataTransfer.dropEffect="move"}_onDrop(t,e){t.preventDefault();const o=Number(t.dataTransfer.getData("text/plain"));if(isNaN(o)||o===e)return;const i=[...this.fields],[s]=i.splice(o,1);i.splice(e,0,s),this.fields=i,this._notify()}render(){const t="definition"===this.mode,e="value"===this.mode;return c`
  ...
  `,q([l({type:Array})],J.prototype,"fields",2),q([l({type:String})],J.prototype,"mode",2),q([l({type:Boolean})],J.prototype,"readonly",2),q([l({type:Boolean})],J.prototype,"showDrag",2),J=q([p("dynamic-field-list")],J);var V=Object.defineProperty,Y=Object.getOwnPropertyDescriptor,K=(t,e,o,i)=>{for(var s,r=i>1?void 0:i?Y(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=(i?s(e,o,r):s(r))||r);return i&&r&&V(e,o,r),r};let H=class extends d{constructor(){super(...arguments),this._i18n=new t(this),this.mode="definition",this.name="",this.description="",this.url="",this.fields=[],this.buttonName="",this.buttonSelector=""}_notify(){this.dispatchEvent(new CustomEvent("form-change",{detail:{name:this.name,description:this.description,url:this.url,fields:[...this.fields],buttonName:this.buttonName,buttonSelector:this.buttonSelector},bubbles:!0,composed:!0}))}_onInput(t,e){this[t]=e.target.value,this._notify()}_onFieldsChange(t){this.fields=t.detail,this._notify()}render(){const t="definition"===this.mode;return c`
      <div class="form">
        <div class="row">
  ...
  `,K([l({type:String})],H.prototype,"mode",2),K([l({type:String})],H.prototype,"name",2),K([l({type:String})],H.prototype,"description",2),K([l({type:String})],H.prototype,"url",2),K([l({type:Array})],H.prototype,"fields",2),K([l({type:String})],H.prototype,"buttonName",2),K([l({type:String})],H.prototype,"buttonSelector",2),H=K([p("form-config")],H);var Q=Object.defineProperty,W=Object.getOwnPropertyDescriptor,G=(t,e,o,i)=>{for(var s,r=i>1?void 0:i?W(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=(i?s(e,o,r):s(r))||r);return i&&r&&Q(e,o,r),r};let X=class extends d{constructor(){super(...arguments),this.active="form",this.formLabel="Form",this.jsonLabel="JSON Import"}_select(t){t!==this.active&&(this.active=t,this.dispatchEvent(new CustomEvent("mode-change",{detail:{mode:t},bubbles:!0,composed:!0})))}render(){return c`
  ...
  `,et([l({type:String})],ot.prototype,"label",2),et([l({type:String})],ot.prototype,"hint",2),et([l({type:String})],ot.prototype,"placeholder",2),et([l({type:String})],ot.prototype,"value",2),et([l({type:String})],ot.prototype,"error",2),ot=et([p("json-import-editor")],ot);var it=Object.defineProperty,st=Object.getOwnPropertyDescriptor,rt=(t,e,o,i)=>{for(var s,r=i>1?void 0:i?st(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=(i?s(e,o,r):s(r))||r);return i&&r&&it(e,o,r),r};let nt=class extends d{constructor(){super(...arguments),this.title="",this.description="",this.prompt="",this.copyLabel="Copy prompt",this.copiedLabel="Copied",this.failedLabel="Copy failed",this._status="idle"}disconnectedCallback(){super.disconnectedCallback(),this._resetTimer&&clearTimeout(this._resetTimer)}async _copy(){try{await navigator.clipboard.writeText(this.prompt),this._status="copied"}catch{this._status="failed"}this._resetTimer&&clearTimeout(this._resetTimer),this._resetTimer=setTimeout(()=>{this._status="idle"},2200)}render(){const t="copied"===this._status?this.copiedLabel:"failed"===this._status?this.failedLabel:this.copyLabel;return c`
      <aside class="card">
        ...
        <button type="button" @click=${this._copy} aria-label=${t}>
          ${"copied"===this._status?c`
  ...
  `,rt([l({type:String})],nt.prototype,"title",2),rt([l({type:String})],nt.prototype,"description",2),rt([l({type:String})],nt.prototype,"prompt",2),rt([l({type:String})],nt.prototype,"copyLabel",2),rt([l({type:String})],nt.prototype,"copiedLabel",2),rt([l({type:String})],nt.prototype,"failedLabel",2),rt([h()],nt.prototype,"_status",2),nt=rt([p("skill-prompt-card")],nt);var at=Object.defineProperty,lt=Object.getOwnPropertyDescriptor,dt=(t,e,o,i)=>{for(var s,r=i>1?void 0:i?lt(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=(i?s(e,o,r):s(r))||r);return i&&r&&at(e,o,r),r};let ct=class extends d{constructor(){super(...arguments),this.open=!1,this.title="",this.size="medium",this._onKeyDown=t=>{"Escape"===t.key&&this.close()}}close(){this.open=!1,this.dispatchEvent(new CustomEvent("modal-close",{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._onKeyDown)}render(){return this.open?c`
      <div class="overlay">
  ...
  `,dt([l({type:Boolean,reflect:!0})],ct.prototype,"open",2),dt([l({type:String})],ct.prototype,"title",2),dt([l({type:String})],ct.prototype,"size",2),ct=dt([p("modal-dialog")],ct);var pt=Object.defineProperty,ht=Object.getOwnPropertyDescriptor,ut=(t,e,o,i)=>{for(var s,r=i>1?void 0:i?ht(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=(i?s(e,o,r):s(r))||r);return i&&r&&pt(e,o,r),r};let gt=null,bt=class extends d{constructor(){super(...arguments),this._i18n=new t(this),this.mode="add",this.data={},this._formData={name:"",description:"",url:"",fields:[],buttonName:"",buttonSelector:""},this._inputMode="form",this._jsonText="",this._jsonError="",this._jsonDirty=!1}open(t){t?(this.data={...t},this._formData={name:t.name,description:t.description,url:t.url,fields:t.fields.map(t=>({id:t.id,name:t.name,selector:t.selector,value:""})),buttonName:t.button?.name??"",buttonSelector:t.button?.selector??""}):this._formData=gt?{...gt,fields:[...gt.fields]}:{name:"",description:"",url:"",fields:[],buttonName:"",buttonSelector:""},this._inputMode="form",this._jsonText=this._serializeFormData(),this._jsonError="",this._jsonDirty=!1,this.requestUpdate();const e=this.renderRoot.querySelector("#modal");e&&(e.open=!0)}close(){"add"===this.mode&&this._saveDraft();const t=this.renderRoot.querySelector("#modal");t&&(t.open=!1),this.dispatchEvent(new CustomEvent("modal-close",{bubbles:!0,composed:!0}))}_onFormChange(t){this._formData=t.detail,this.requestUpdate()}_serializeFormData(){const t=this._formData;return JSON.stringify([{name:t.name,description:t.description,url:t.url,fields:t.fields.map(t=>({name:t.name,selector:t.selector??""})),...t.buttonSelector.trim()?{button:{name:t.buttonName||"Submit",selector:t.buttonSelector}}:{}}],null,2)}_onModeChange(t){this._inputMode=t.detail.mode,"json"!==this._inputMode||this._jsonDirty||(this._jsonText=this._serializeFormData()),this._jsonError="",this.requestUpdate()}_onJsonChange(t){this._jsonText=t.detail.value,this._jsonError="",this._jsonDirty=!0,this.requestUpdate()}_submit(){if("json"===this._inputMode){try{const t=function(t){const e=F(t);if(!Array.isArray(e.fields))throw new Error("fields must be an array.");const o=e.fields.map((t,e)=>{const o=M(t,`fields[${e}]`);return{id:N(o.id)||crypto.randomUUID(),name:R(o.name,`fields[${e}].name`),selector:N(o.selector)}});let i;if(void 0!==e.button&&null!==e.button){const t=M(e.button,"button"),o=N(t.selector);o&&(i={name:N(t.name)||"Submit",selector:o})}return{name:R(e.name,"name"),description:N(e.description),url:N(e.url),fields:o,button:i}}(this._jsonText);this.dispatchEvent(new CustomEvent("template-submit",{detail:t,bubbles:!0,composed:!0})),this._clearDraft(),this.close()}catch{this._jsonError=this._i18n.t("config.jsonInvalid"),this.requestUpdate()}return}const t=this._formData;if(!t.name.trim())return;const e=t.fields.filter(t=>t.name.trim()).map(t=>({id:t.id,name:t.name.trim(),selector:t.selector?.trim()??""})),o=t.buttonSelector.trim()?{name:t.buttonName.trim()||"Submit",selector:t.buttonSelector.trim()}:void 0;this.dispatchEvent(new CustomEvent("template-submit",{detail:{name:t.name.trim(),description:t.description.trim(),url:t.url.trim(),fields:e,button:o},bubbles:!0,composed:!0})),this._clearDraft(),this.close()}_saveDraft(){gt={...this._formData,fields:[...this._formData.fields]}}_clearDraft(){gt=null}render(){const t="edit"===this.mode?this._i18n.t("template.edit"):"copy"===this.mode?this._i18n.t("template.copy"):"extract"===this.mode?this._i18n.t("template.extract"):this._i18n.t("template.new");return c`
  ...
  `,vt([l({type:String})],$t.prototype,"mode",2),$t=vt([p("data-wizard")],$t);var St=Object.defineProperty,Dt=Object.getOwnPropertyDescriptor,Ct=(t,e,o,i)=>{for(var s,r=i>1?void 0:i?Dt(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=(i?s(e,o,r):s(r))||r);return i&&r&&St(e,o,r),r};let Tt=class extends d{constructor(){super(...arguments),this._i18n=new t(this),this._records=new i(this,s,!0),this._searchQuery="",this._selectedIds=[],this._deleteTarget=[]}get _columns(){return[{key:"name",label:this._i18n.t("template.name"),sortable:!0,width:"160px"},{key:"url",label:this._i18n.t("template.url"),sortable:!1,width:"240px"},{key:"description",label:this._i18n.t("template.description"),sortable:!1}]}get _actions(){return[{key:"edit",label:this._i18n.t("config.edit")},{key:"copy",label:this._i18n.t("config.copy")},{key:"delete",label:this._i18n.t("config.delete")},{key:"extract",label:this._i18n.t("data.extractTemplate")},{key:"export",label:this._i18n.t("config.export")}]}get _filtered(){return v(this._records.state,this._searchQuery,["name","url"])}_onSearch(t){this._searchQuery=t.detail.value,this.requestUpdate()}_onSelection(t){this._selectedIds=t.detail,this.requestUpdate()}_onRowAction(t){const{action:e,row:o}=t.detail,i=o;switch(e){case"edit":this._editData=i,this._wizard.mode="edit",this._wizard.open(i);break;case"copy":this._wizard.mode="copy",this._wizard.open({...i,name:i.name+" (Copy)"});break;case"delete":this._deleteTarget=[i.id],this._confirm.title=this._i18n.t("data.deleteTitle"),this._confirm.message=this._i18n.t("data.deleteMsg",{name:i.name}),this._confirm.open=!0;break;case"extract":{const t=w.getById(i.templateId),e=i.values.length>0?i.values.map(t=>({id:t.name,name:t.name,selector:t.selector})):(t?.fields??[]).map(t=>({id:t.id,name:t.name,selector:t.selector})),o={id:"",name:i.name,description:i.description||t?.description||"",url:i.url,fields:e,button:i.buttonSelector?{name:i.buttonName||"",selector:i.buttonSelector}:void 0,createdAt:Date.now(),updatedAt:Date.now()};this._tmodal.mode="extract",this._tmodal.open(o);break}case"export":this._exportSelection([i.id])}}async _onConfirm(){if(this._deleteTarget.length){const t=this._deleteTarget.length;await s.deleteMany(this._deleteTarget),this._deleteTarget=[],this._selectedIds=[];const{showToast:e}=await y(async()=>{const{showToast:t}=await import("./toast-notification-CTcGFgSq.js").then(t=>t.t);return{showToast:t}},__vite__mapDeps([0,1]));e(this._i18n.t("data.deleted",{count:t}),"success"),this.requestUpdate()}}async _onDataSubmit(t){const e=t.detail;this._editData?await s.update(this._editData.id,e):await s.add(e),this._editData=void 0}async _onExtractSubmit(t){const e=t.detail;await w.add(e);const{showToast:o}=await y(async()=>{const{showToast:t}=await import("./toast-notification-CTcGFgSq.js").then(t=>t.t);return{showToast:t}},__vite__mapDeps([0,1]));o(this._i18n.t("data.templateExtracted"),"success")}_onBatchExport(){this._exportSelection(this._selectedIds)}_exportSelection(t){k(this._records.state.filter(e=>t.includes(e.id)),"data-records")}async _onBatchImport(t){try{const e=$(t.detail.content),o=await s.importFrom(e),{showToast:i}=await y(async()=>{const{showToast:t}=await import("./toast-notification-CTcGFgSq.js").then(t=>t.t);return{showToast:t}},__vite__mapDeps([0,1]));i(this._i18n.t("data.imported",{count:o}),"success")}catch{const{showToast:t}=await y(async()=>{const{showToast:t}=await import("./toast-notification-CTcGFgSq.js").then(t=>t.t);return{showToast:t}},__vite__mapDeps([0,1]));t(this._i18n.t("data.importFailed"),"error")}}_onBatchDelete(){this._deleteTarget=[...this._selectedIds],this._confirm.title=this._i18n.t("data.deleteBatchTitle"),this._confirm.message=this._i18n.t("data.deleteBatchMsg",{count:this._deleteTarget.length}),this._confirm.open=!0}_openAdd(){this._editData=void 0,this._wizard.mode="add",this._wizard.open()}render(){const t=this._filtered;return c`
    ...
    .add-btn:hover { background: #1d4ed8; }
  `,Ct([u("data-wizard")],Tt.prototype,"_wizard",2),Ct([u("confirm-dialog")],Tt.prototype,"_confirm",2),Ct([u("template-modal")],Tt.prototype,"_tmodal",2),Tt=Ct([p("data-management")],Tt);var jt=Object.getOwnPropertyDescriptor;let Et=class extends d{constructor(){super(...arguments),this._i18n=new t(this),this._settings=new i(this,r)}connectedCallback(){super.connectedCallback(),this._settings.load()}_toggle(t){const e=t.target.checked;r.setCookieCopyEnabled(e)}render(){const t=this._settings.state.cookieCopyEnabled;return c`
      <div class="section">
  ...
  `,Et=((t,e,o,i)=>{for(var s,r=i>1?void 0:i?jt(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=s(r)||r);return r})([p("cookie-settings")],Et);var It=Object.getOwnPropertyDescriptor;const zt={zh:{title:"用户指南",tocTitle:"目录",intro:"FormBridge 是一款 Chrome 浏览器扩展，提供两大核心功能：<strong>表单自动填充</strong>和<strong>Cookie 跨域复制</strong>。",pages:[{id:"popup",title:"弹窗页",sections:[{id:"popup-overview",title:"界面概览",body:c`
    ...
    `}},en:{title:"User Guide",tocTitle:"Contents",intro:"FormBridge is a Chrome extension with two core features: <strong>Form Auto-fill</strong> and <strong>Cross-domain Cookie Copy</strong>.",pages:[{id:"popup",title:"Popup",sections:[{id:"popup-overview",title:"Interface Overview",body:c`
    ...
    `}}};let Ot=class extends d{constructor(){super(...arguments),this._i18n=new t(this)}_scrollTo(t){const e=this.shadowRoot?.getElementById(t);e&&e.scrollIntoView({behavior:"smooth",block:"start"})}_pageDotClass(t){return 0===t?"popup":"config"}render(){const t=n(),e=zt[t]??zt.en;return c`
      <nav class="sidebar">
        <h4>${e.tocTitle}</h4>
        <ul class="toc-list">
          ${e.pages.map((t,e)=>c`
  ...
  `,Ot=((t,e,o,i)=>{for(var s,r=i>1?void 0:i?It(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=s(r)||r);return r})([p("guide-page")],Ot);var At=Object.defineProperty,Lt=Object.getOwnPropertyDescriptor,Pt=(t,e,o,i)=>{for(var s,r=i>1?void 0:i?Lt(e,o):e,n=t.length-1;n>=0;n--)(s=t[n])&&(r=(i?s(e,o,r):s(r))||r);return i&&r&&At(e,o,r),r};let Mt=class extends d{constructor(){super(...arguments),this._i18n=new t(this),this._tab="data"}_onTabChange(t){this._tab=t.detail}_toggleLang(){r.setLanguage("en"===n()?"zh":"en")}render(){return c`
      <div class="main">
  ...
  `,Pt([h()],Mt.prototype,"_tab",2),Mt=Pt([p("config-app")],Mt);
